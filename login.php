...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset ('assets/dist/img/bnn.png') }}">
  <title>Login</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <link rel="shortcut icon" href="<?= base_url() ?>/assets/dist/img/bnn.png">
  <!-- Font Awesome -->
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h2 style="color:darkcyan; font-family: system-ui;"><b>BNNP</b><br>
          KALIMANTAN SELATAN
        </h2>
        <h3>
          <img class="" src="<?= base_url() ?>/assets/dist/img/bnn.png" style="margin-top: 20px; margin-bottom: 20px;" width="200px;" height="200px;">
