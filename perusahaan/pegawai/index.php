                        ...
                        <div class="col-12">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <a href="tambah" class="btn btn-success"><i class="fa fa-edit mr-1"></i>Tambah Pegawai</a>
                                                ...
                                                <tbody style="background-color: white">
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <a href="hapus?id=<?= $row['id_pegawai'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            <?php } ?>
