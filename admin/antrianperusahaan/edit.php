...
LEFT JOIN perusahaan AS pr ON pl.id_perusahaan = pr.id_perusahaan WHERE p.id_pendaftaran_pegawai = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE pendaftaran_pegawai SET  
                            tgl_buat = '$tgl_buat',
                            tgl_ambil = '$tgl_ambil',
                            hasil_tes = '$hasil_tes',
                            status_pendaftaran = '$status_pendaftaran'
                            WHERE 
                            id_pendaftaran_pegawai = '$id'");
        // var_dump($submit, $koneksi->error);
        // die();
        if ($submit) {
            $_SESSION['pesan'] = "Data Sudah Diproses";
            echo "<script>window.location.replace('../antrianperusahaan/');</script>";
        }
    }
